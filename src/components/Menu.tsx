...
export default function Menu({ submenu } : {submenu : string}) {
  ...
  console.log(submenu);
    ...
    const handleOrder = (itemName: string, increment: boolean) => {
        setOrder(prevOrder => {
          ...
          // Remove item from order if quantity becomes 0
          if (newQuantity === 0) {
  ...
  if(submenu === "Veg"){
                ...
                <CardContent className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    <Button 
                      variant="outline" 
                      size="icon"
                      onClick={() => handleOrder(item.name, false)}
                    ...
                    <Button
                      variant="outline" 
                      size="icon"
                      onClick={() => handleOrder(item.name, true)}
                    >
    ...
    } else if(submenu === "Thali"){
      return <>
      <h1 className="text-center font-bold text-xl mb-4">Veg Thali</h1>
      ...
      <h1 className="text-center font-bold text-xl mb-4">Non-Veg Thali</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
